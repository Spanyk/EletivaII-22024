...
<div class="exercicio"> 3 </div>
<span class="text-center"><p class="fw-bold fs-4 text mt-4"> Multiplicar </p></span>

        <form class="row g-3 mt-4" action="/resultado-exercicio-3" method="POST">
            @CSRF
            @method('GET')
            <div class="col-md-12">
            ...
            <div class="col-md-12 text-center"><p class="text fw-bold fs-2"> x </p></div>
            <div class="col-md-12">
                <div class="form-floating mb-3">
