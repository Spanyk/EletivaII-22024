...
<body>
    <div class="container-sm border mt-4">
        <div class="exercicio">10</div>
        <span class="text-center"><p class="fw-bold fs-4 text mt-4">Calculo do Perímetro: Retângulo </p></span>
        
        <form class="row g-3 mt-4" action="/resultado-exercicio-10" method="POST">
            @CSRF
            @method('GET')
            <div class="col-sm-6">
