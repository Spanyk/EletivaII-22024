...
<div class="exercicio"> 5 </div>
<span class="text-center"><p class="fw-bold fs-4 text mt-4"> Calcular: Média </p></span>

        <form class="row g-3 mt-4" action="/resultado-exercicio-5" method="POST">
            @CSRF
            @method('GET')
            <div class="col-md-12">
