...
<body>
    <div class="container-sm border mt-4">
        <div class="exercicio">7</div>
        <span class="text-center"><p class="fw-bold fs-4 text mt-4">Conversor de Temperatura para Celcius</p></span>
        
        <form class="row g-3 mt-4" action="/resultado-exercicio-7" method="POST">
            @CSRF
            @method('GET')
            <div class="col-sm-12">
                <div class="form-floating mb-3">
                    <input type="text" name="celsius" id="celsius" class="form-control">
