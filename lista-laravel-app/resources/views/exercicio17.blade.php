...
<body>
    <div class="container-sm border mt-4">
        <div class="exercicio">17</div>
        <span class="text-center"><p class="fw-bold fs-4 text mt-4">Calculo: Juros Simples</p></span>
        
        <form class="row g-3 mt-4" action="/resultado-exercicio-17" method="POST">
            @CSRF
            @method('GET')
            <div class="col-sm-4">
